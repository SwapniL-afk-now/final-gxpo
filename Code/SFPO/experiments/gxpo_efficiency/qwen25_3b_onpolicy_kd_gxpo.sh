...
#
# Usage:
#   bash qwen25_3b_onpolicy_kd_gxpo.sh            # launch
#   bash qwen25_3b_onpolicy_kd_gxpo.sh --dry-run  # preflight only
set -euo pipefail
...
RUN_NAME="${RUN_NAME:-${MODEL_ALIAS}_onpolicy_kd_gxpo_k${K:-3}_a${REPOSITION_ALPHA:-0.1}_b256_topk${KD_TOPK:-32}}"
