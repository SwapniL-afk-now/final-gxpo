#!/usr/bin/env bash
#
# llama32_3b_gxpo_muon_transactional_b128_mb32.sh
#
...
#
# Usage:
#   bash llama32_3b_gxpo_muon_transactional_b128_mb32.sh            # launch
#   bash llama32_3b_gxpo_muon_transactional_b128_mb32.sh --dry-run  # print resolved
#                                                      # config, no launch
set -euo pipefail
