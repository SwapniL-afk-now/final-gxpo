...
# Student: Qwen2.5-Math-1.5B-Instruct.  Teacher: frozen Qwen2.5-Math-7B
...
RUN_NAME="${RUN_NAME:-${MODEL_ALIAS}_onpolicy_kd_gxpo_k${K:-10}_a${REPOSITION_ALPHA:-0.3}_b256_topk${KD_TOPK:-32}}"
