#!/usr/bin/env bash
# Group-2 ablation: no corrective pass (skip 3rd backward; use theta after reposition directly)
# Reviewer question answered: mbJD Q1 -- why do we need the third backward pass?
# Self-contained -- a reviewer can run this directly:  GPU=1 ./train-scripts/run_ablation_no_corrective.sh
...
EXP="gxpo_k${K}_a${ALPHA}_tau${GXPO_TAU}_mathl35_amc23_seed${TRAIN_SEED}_nocorr"
RUN_DIR="./runs/${EXP}"
mkdir -p "$RUN_DIR"
